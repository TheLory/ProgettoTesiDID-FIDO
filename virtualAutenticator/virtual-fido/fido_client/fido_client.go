...
const (
	...
	//aggiunta da me
	CLientActionFIDOSignVP ClientAction = 4
)
...
// aggiutna da me
func (client DefaultFIDOClient) ApproveU2FVPSign(keyHandle *webauthn.KeyHandle) bool {
	params := ClientActionRequestParams{}
	return client.requestApprover.ApproveClientAction(CLientActionFIDOSignVP, params)
}
